...
\begin{frontmatter}
  ...
  % \address[mi]{Università degli Studi di Milano, Milano, Italy}
...
\begin{figure*}[]
  \centering
  \includegraphics[width=.85\textwidth]{./artwork/Fig:pics_.png}
...
%\begin{figure*}[]
  \centering
  \includegraphics[width=1\textwidth]{./artwork/Fig:log_.png}
...
%% GK: scapulae and pelves are appendicular elements! explain why you put together with axial elements
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{./artwork/Fig:ams.png}
...
%%% GK: 1)rotule,sesamoid,carpal/tarsal,carpal and tarsal should be united in one group called "carpal/tarsal/sesamoid". 2)limb bone = long bone frag. 3)re-order in anatomical meaning.
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{./artwork/Fig:micro.png}
...
%%% M&Ms: in the polledrara site, there is a stunning example of fossil remains that rest in the trough of sedimentary structures (small dunes), thus forming bands oriented perpendicular to paleoflow. I  think we definitely need to inlcude a descritpion of GEO3 deposits

% \citep{Journel1982}, Anisotropic Hole-Effect Modeling!
